    ...
    <div className="space-y-6">
      ...
      <div className="glass-panel p-4 sm:p-6 rounded-2xl border border-white/5 space-y-4">
        ...
        <div className="flex items-center gap-2 pt-1 text-xs text-slate-500">
          ...
          <span>Live scan: Solana Mainnet RPC · Pump.fun transactions · DexScreener prices</span>
        </div>
      </div>
      ...
      {!isLoading && !walletData && !error && (
        <div className="glass-panel p-10 rounded-2xl border border-white/5 text-center space-y-3">
          <Crosshair className="w-10 h-10 text-emerald-400/70 mx-auto" />
          <h2 className="text-lg font-bold text-white">Screen a real Solana wallet</h2>
          <p className="max-w-lg mx-auto text-sm text-slate-400">
            Enter a wallet address above. Every metric on the result page is calculated from fresh Solana Mainnet RPC transactions and live DexScreener prices.
          </p>
          <p className="text-xs text-slate-500 font-mono">
            No demo wallets or simulated performance data are loaded.
          </p>
        </div>
      )}
              ...
              <div className="flex items-center gap-4 self-start lg:self-center">
                ...
                <div className="p-3 px-4 rounded-xl bg-dark-900 border border-white/5 text-center min-w-[110px]">
                  ...
                  <p className={`text-2xl font-black font-mono mt-0.5 ${
                    walletData.summary?.smartScore == null
                      ? 'text-slate-400'
                    ...
                    {walletData.summary?.smartScore == null ? '—' : walletData.summary.smartScore}
                    {walletData.summary?.smartScore != null && (
